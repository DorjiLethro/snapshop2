<?php
    ...
    if(isset($_POST['searchValue'])) {
        ...
        $sql = "select * from product where category = 'clothes' and product_title like '{$input}%' or category like '{$input}%' or price like '{$input}%' or description like '{$input}%' or location like '{$input}%' or product_condition like '{$input}%'";
